...
export default function InstaTile ({ url }) {
  ...
  return (
    <>
      <InstagramEmbed
        url=''
        clientAccessToken={process.env.REACT_APP_INSTAGRAM_KEY}
        maxWidth={320}
        hideCaption={true}
      ...
      <blockquote class="instagram-media" data-instgrm-permalink={link} data-instgrm-version="13" style={{ background: '#FFF', border: 0, borderRadius: '3px', boxShadow: '0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)', margin: '1px', maxWidth: '135px', minWidth: '0px', padding: 0, width: '-webkit-calc(100% - 2px)'}}>
